...
var Rectangle = function () {
    ...
    _createClass(Rectangle, [{
        ...
        key: "isValidRectangle",
        value: function isValidRectangle() {
...
var TilesetStore = function () {
    function TilesetStore() {
        _classCallCheck(this, TilesetStore);
    ...
    _createClass(TilesetStore, [{
        key: 'add',
        value: function add(tileset) {
        ...
        key: 'exists',
        value: function exists(tileset) {
            return this._tilesets.find(function (ts) {
...
var _TilesetStore = __webpack_require__(4);

var _TilesetStore2 = _interopRequireDefault(_TilesetStore);

var _Tileset = __webpack_require__(7);

var _Tileset2 = _interopRequireDefault(_Tileset);

var _SpriteStore = __webpack_require__(18);

var _SpriteStore2 = _interopRequireDefault(_SpriteStore);
...
var Sprite = function () {
    function Sprite(sheet, x, y, width, height, name) {
        ...
        this._width = width;
        this._height = height;
        this._tileset = sheet instanceof _Tileset2.default ? sheet : _TilesetStore2.default.get(sheet);
    ...
    _createClass(Sprite, [{
        ...
        value: function render(ctx, x, y, w, h) {
            ...
            ctx.drawImage(this.getTileset().getTilesetImage(), this.getX(), this.getY(), this.getWidth(), this.getHeight(), x, y, w, h);
        }
    }]);
...
var Tileset = function () {
    function Tileset(tileset) {
        ...
        this._tilesetImage.src = _Globals2.default.IMG_PATH + tileset.image;
    ...
    _createClass(Tileset, [{
        key: 'getTileCoords',
        value: function getTileCoords(id) {
        ...
        value: function getTileFromCoords(x, y, width, height) {}
    }, {
        key: 'getName',
        value: function getName() {
            return this._name;
        ...
        key: 'getTilesetImage',
        value: function getTilesetImage() {
            return this._tilesetImage;
        }
    }, {
        key: 'getTilesetImageSrc',
        value: function getTilesetImageSrc() {
            return this._tilesetImageSrc;
        }
    }, {
        key: 'getTilesetImageName',
        value: function getTilesetImageName() {
        ...
        key: 'getTilesetWidth',
        value: function getTilesetWidth() {
            return this._tilesetWidth;
        }
    }, {
        key: 'getTilesetHeight',
        value: function getTilesetHeight() {
...
var AnimatedSprite = function () {
    function AnimatedSprite(spriteArr, animationName) {
    ...
    _createClass(AnimatedSprite, [{
        key: 'buildAnimation',
        value: function buildAnimation(animationObject) {}
    }, {
        key: 'getNextFrame',
        value: function getNextFrame() {
            this._currentFrame++;
            if (!this._frames[this._currentFrame]) {
                // check for looping eventually
                this._currentFrame = 0;
            }
        ...
        key: 'render',
        value: function render(ctx, x, y, w, h, scale, time) {
...
var MapStore = function () {
    ...
    _createClass(MapStore, [{
        key: "add",
        value: function add(map) {
            this.maps.push(map);
        }
    }, {
        key: "exists",
        value: function exists(map) {
            return this.maps.find(function (m) {
                return map.id == m.id;
            });
        }
    }]);
...
var _AnimatedSprite = __webpack_require__(13);
...
var Player = function () {
	function Player(x, y) {
		...
		this.spriteStore = _SpriteStore2.default;
		this._builtGraphics = false;
		if (!Player.instance) {
			Player.instance = this;
			this._playerSize = _Globals2.default.TILE_WIDTH;
			this._movementSpeed = 5;
			this._facing = _Globals2.default.FACING.DOWN;
			// player positioning
			this._bounds = new _Rectangle2.default(x, y, 16, 32);
			...
			this.getPlayerSprite = function () {
				var tileset = _TilesetStore2.default.get('DungeonTileset2');
				var coords = tileset.getTileCoords(107);
				return { tileset: tileset, coords: coords };
			};
		}
	...
	_createClass(Player, [{
		key: 'buildGraphics',
		value: function buildGraphics() {
			var playerTileset = null;
			if (_TilesetStore2.default.exists("DungeonTileset2")) {
				playerTileset = _TilesetStore2.default.get("DungeonTileset2");
			} else {
				playerTileset = _TilesetStore2.default.add(new _Tileset2.default("DungeonTileset2"));
			}
			var spriteArr = this.spriteStore.add([new _Sprite2.default(playerTileset, 144, 32, 16, 32, "playerIdle01"), new _Sprite2.default(playerTileset, 160, 32, 16, 32, "playerIdle02"), new _Sprite2.default(playerTileset, 176, 32, 16, 32, "playerIdle03"), new _Sprite2.default(playerTileset, 192, 32, 16, 32, "playerIdle04"), new _Sprite2.default(playerTileset, 208, 32, 16, 32, "playerIdle05"), new _Sprite2.default(playerTileset, 224, 32, 16, 32, "playerIdle06"), new _Sprite2.default(playerTileset, 240, 32, 16, 32, "playerIdle07"), new _Sprite2.default(playerTileset, 256, 32, 16, 32, "playerIdle08")]);

			var animation = new _AnimatedSprite2.default(spriteArr);
			this._animations = {
				walkUp: animation,
				walkDown: animation,
				walkLeft: animation,
		...
		value: function render(ctx, time) {
			this._animations.walkUp.render(ctx, this.getBounds().getX(), this.getBounds().getY(), this.getBounds().getWidth(), this.getBounds().getHeight(), 1, time);

			// for collision debugging
			if (_Config2.default.renderPlayerBounds) {
				ctx.strokeStyle = "green";
				ctx.strokeRect(this.getBounds().getX(), this.getBounds().getY(), this.getBounds().getWidth(), this.getBounds().getHeight());
			}
		}
	}]);
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // Viewport >> Scene >> Children
...
var SpriteStore = function () {
    function SpriteStore() {
        _classCallCheck(this, SpriteStore);
    ...
    _createClass(SpriteStore, [{
        ...
        key: "exists",
        value: function exists(sprite) {
            return this.sprites.find(function (s) {
                return sprite.id == s.id;
            });
        }
    }, {
        key: "get",
        value: function get(sprite) {
            return this.sprites.find(function (s) {
                return sprite.id == s.id;
            });
        }
...
var UI = function () {
    ...
    _createClass(UI, [{
        ...
        key: 'createCanvas',
        value: function createCanvas(id, parent, width, height) {
            var canvas = _index2.default.CanvasStore.create(id, parent, width * _Globals2.default.TILE_WIDTH, height * _Globals2.default.TILE_HEIGHT);
            return canvas;
        }
    }, {
        key: 'createPanel',
        value: function createPanel(id, parent) {
...
var _axiosWrapper = __webpack_require__(50);
...
var MapService = function () {
    function MapService() {
        ...
        this.baseurl = '/maps/';
        this.ajax = new _axiosWrapper2.default(this.baseurl);
    }
...
var _GameMap = __webpack_require__(47);
...
var _MapStore = __webpack_require__(14);

var _MapStore2 = _interopRequireDefault(_MapStore);

var _MapService = __webpack_require__(20);
...
var Game = function () {
	function Game(Config) {
		...
		//this.player = Player;
		this.viewports = [];
		this.mapStore = _MapStore2.default;

		// should this be a singleton?
		this.mapService = new _MapService2.default();
		this.map = new _GameMap2.default(Config.firstMap, true, this.mapService);
		...
		var top = _UI2.default.createPanel("top", this.container);
		//TODO: How would I handle this using Tiled?
		var topScene = new _Scene2.default([this.map]);
		var mapViewport = new _Viewport2.default("map", top, 20, 20, topScene);
		this.viewports.push(mapViewport);

		var bottom = _UI2.default.createPanel("bottom", this.container);
		this.console = new _Console2.default(bottom);
...
var Controls = function () {
    ...
    _createClass(Controls, [{
        ...
        value: function moveUp() {
            if (this.checkUp()) {
                _Player2.default.setPositionY(_Player2.default.getBounds().getY() - _Player2.default.getMovementSpeed());
                // player.update();
        ...
        value: function checkUp() {
            var up = new _Rectangle2.default(_Player2.default.getBounds().getX(), _Player2.default.getBounds().getY() - _Player2.default.getMovementSpeed(), _Globals2.default.TILE_WIDTH, _Globals2.default.TILE_HEIGHT);
        ...
        value: function checkDown() {
            var down = new _Rectangle2.default(_Player2.default.getBounds().getX(), _Player2.default.getBounds().getY() + _Player2.default.getMovementSpeed(), _Globals2.default.TILE_WIDTH, _Globals2.default.TILE_HEIGHT);
        ...
        value: function moveRight() {
            if (this.checkRight()) {
                _Player2.default.setPositionX(_Player2.default.getBounds().getX() + _Player2.default.getMovementSpeed());
                // player.update();
                // this.checkForEvent(player, this.game.map);
            }
        }
        ...
        value: function checkRight() {
            var right = new _Rectangle2.default(_Player2.default.getBounds().getX() + _Player2.default.getMovementSpeed(), _Player2.default.getBounds().getY(), _Globals2.default.TILE_WIDTH, _Globals2.default.TILE_HEIGHT);
        ...
        key: 'checkLeft',
        value: function checkLeft() {
            var left = new _Rectangle2.default(_Player2.default.getBounds().getX() - _Player2.default.getMovementSpeed(), _Player2.default.getBounds().getY(), _Globals2.default.TILE_WIDTH, _Globals2.default.TILE_HEIGHT);
            return !this.checkCollisions(left);
        }
    }, {
        key: 'checkCollisions',
        value: function checkCollisions(rect) {
            var collisions = this.game.map.collisions;
            var a = collisions.find(function (collision) {
                return rect.collidesWith(collision);
            });
            return a;
        }
    }, {
        ...
        value: function checkForEvent(player, map) {
            ...
            try {
                for (var _iterator = map.events[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    if (e.x == player.getBounds().getX() && e.y == player.getBounds().getY() + _Globals2.default.TILE_HEIGHT) {
                        this.events.push(e);
                    }
                }
            } catch (err) {
        ...
        key: 'toggleInventoryStatusPanel',
        value: function toggleInventoryStatusPanel() {
            var ui = this.game.ui;
            if (!ui.inventoryOpen) {
                ui.viewInventory();
            } else {
...
var Canvas = function () {
    ...
    _createClass(Canvas, [{
        ...
        key: 'create',
        value: function create(id, w, h, parent) {
...
exports.default = CanvasInstance;
...
var CanvasStore = function () {
    ...
    _createClass(CanvasStore, [{
        key: 'create',
        value: function create(id, parent, width, height) {
            if (!this.canvasStore.hasOwnProperty(id)) {
                return _Canvas2.default.create(id, width, height, parent);
            } else {
                return _Canvas2.default.get(id);
                // Canvas.clear(id);
            }
        ...
        key: 'add',
        value: function add(id, w, h, parent) {
            return _Canvas2.default.create(id, w, h, parent);
        }
    }, {
        key: 'get',
        value: function get() {
...
var CanvasStoreInstance = new CanvasStore();
Object.freeze(CanvasStoreInstance);
exports.default = CanvasStoreInstance;
...
var _CanvasStore = __webpack_require__(44);
...
exports.default = {
    CanvasStore: _CanvasStore2.default
};
	...
	this.eventList = {
		...
		teleport: function teleport(args, game) {
			...
			game.map.loadMap(args.properties.map, {
				x: (args.properties.destination_x - 1) * _Globals2.default.TILE_WIDTH,
				y: (args.properties.destination_y - 1) * _Globals2.default.TILE_HEIGHT
			});
		...
		item: function item(args, game) {
			...
			if (inv[props.item] < _Globals2.default.ITEM_LIMIT) {
				// add item to inventory
				// TODO: This would be more efficient if you just subtract the overage from the item amt and add it
				while (inv[props.item] < _Globals2.default.ITEM_LIMIT && props.qty > 0) {
...
var MapLayer = function MapLayer(layer) {
...
var TileLayer = function (_MapLayer) {
	_inherits(TileLayer, _MapLayer);

	function TileLayer(layer) {
		_classCallCheck(this, TileLayer);

		var _this = _possibleConstructorReturn(this, (TileLayer.__proto__ || Object.getPrototypeOf(TileLayer)).call(this, layer));

		_this.tiles = layer.data;
		return _this;
	}
...
var ObjectLayer = function (_MapLayer2) {
	_inherits(ObjectLayer, _MapLayer2);

	function ObjectLayer(layer) {
		_classCallCheck(this, ObjectLayer);

		var _this2 = _possibleConstructorReturn(this, (ObjectLayer.__proto__ || Object.getPrototypeOf(ObjectLayer)).call(this, layer));

		_this2.objects = layer.objects;
		return _this2;
	}
...
var GameMap = function () {
	function GameMap(map) {
		var drawMap = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
		var mapService = arguments[2];
	...
	_createClass(GameMap, [{
		...
		value: function getMap(mapId, drawMap) {
			...
			return this.mapService.getMap('map' + mapId + '_new.json').then(function (response) {
				_this3.mapName = mapId;
				if (!_MapStore2.default.exists(response.data)) {
					_this3.map = response.data;
					_this3.parseLayers();
					_this3.parseTilesets();
					_MapStore2.default.add(_this3);
					_this3.loaded = true;
				}
			});
		}
		...
		value: function parseLayers() {
			...
			this.map.layers.forEach(function (layer) {
				if (layer.type.toLowerCase() == 'tilelayer') {
					_this4.layers.push(new TileLayer(layer));
				} else if (layer.type.toLowerCase() == 'objectgroup') {
					_this4.layers.push(new ObjectLayer(layer));
					if (layer.name.toLowerCase() === 'collisions') {
						_this4.collisions = layer.objects.map(function (rect) {
							return new _Rectangle2.default(rect.x, rect.y, rect.width, rect.height);
						});
					}
				}
			});
		...
		key: 'parseTilesets',
		value: function parseTilesets() {
			var _iteratorNormalCompletion = true;
			var _didIteratorError = false;
			var _iteratorError = undefined;

			try {
				for (var _iterator = this.map.tilesets[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
					var tileset = _step.value;

					var mapTileset;
					mapTileset = new _Tileset2.default(tileset);
					if (!_TilesetStore2.default.exists(mapTileset)) {
						_TilesetStore2.default.add(mapTileset);
					} else {
						mapTileset = _TilesetStore2.default.get(tileset.name);
					}
				}
			} catch (err) {
				_didIteratorError = true;
		...
		value: function loadMap(mapId, args) {
			// bit of a misnomer... this seems to be more for teleporting to new maps
			// update mapList with current version of the map
			_MapStore2.default.add(Object.assign(Object.create(this), this));
		...
		value: function getTilesets() {
			...
			try {
				for (var _iterator2 = this.map.tilesets[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
					var tileset = _step2.value;

					var mapTileset = new _Tileset2.default(tileset);
					if (!_TilesetStore2.default.exists(mapTileset)) {
						_TilesetStore2.default.add(mapTileset);
					}
				}
		...
		value: function parseEvents() {
			...
			try {
				for (var _iterator3 = this.map.layers[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
		...
		value: function drawEvents() {
			...
			if (!(eventsContainer = document.querySelector('#events'))) {
				...
				eventsContainer.width = _Globals2.default.MAP_WIDTH * _Globals2.default.TILE_WIDTH;
				eventsContainer.height = _Globals2.default.MAP_HEIGHT * _Globals2.default.TILE_HEIGHT;

				mapElement.appendChild(eventsContainer);
			}

			var ctx = eventsContainer.getContext("2d");
			ctx.clearRect(0, 0, _Globals2.default.MAP_WIDTH * _Globals2.default.TILE_WIDTH, _Globals2.default.MAP_HEIGHT * _Globals2.default.TILE_HEIGHT);
			...
			if (this.events.length > 0) {
				...
				try {
					for (var _iterator4 = this.events[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
						...
						if (e.visible) {
							ctx.fillRect(e.x, e.y - _Globals2.default.TILE_HEIGHT, _Globals2.default.TILE_WIDTH, _Globals2.default.TILE_HEIGHT);
						}
					}
				} catch (err) {
		...
		value: function drawEntities() {
			...
			try {
				for (var _iterator5 = map.layers[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
					...
					if (layer.name == "Entities") {
						if (this.tilesDrawn) {
							...
							if (!(entitiesContainer = document.querySelector('#entities'))) {
								...
								entitiesContainer.width = _Globals2.default.MAP_WIDTH * _Globals2.default.TILE_WIDTH;
								entitiesContainer.height = _Globals2.default.MAP_HEIGHT * _Globals2.default.TILE_HEIGHT;
							...
							try {
								for (var _iterator6 = layer.objects[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
									...
									e.y = e.y - _Globals2.default.TILE_HEIGHT;
								}
							} catch (err) {
		...
		key: 'drawMap',
		value: function drawMap(ctx, time) {
			var _this5 = this;
				...
				if (layer instanceof TileLayer) {
					...
					for (var i = 0; i < layer.height; i++) {
						var _loop = function _loop() {
							var tileset = null;
							var id = tiles[j * map.width + i];
							// which tileset in the map does this belong to?
							var ts = _this5.map.tilesets.find(function (tileset) {
								return id >= tileset.firstgid && id < tileset.tilecount + tileset.firstgid - 1;
							});
							if (ts) {
								var destination_x = i * ts.tilewidth;
								var destination_y = j * ts.tileheight;
								tileset = _TilesetStore2.default.get(ts.name);
								if (tileset) {
									var source = tileset.getTileCoords(id - ts.firstgid);
									ctx.drawImage(tileset.getTilesetImage(), source.x, source.y, tileset.getTileWidth(), tileset.getTileHeight(), destination_x, destination_y, ts.tilewidth, ts.tileheight);
								}
							} else {
								// throw error
							}
					...
					if (layer.name.toLowerCase() == 'entities') {
						if (_this5.entityLayer == null) {
							_this5.entityLayer = layer;
						}
						_this5.entityLayer.objects.forEach(function (obj) {
							if (obj.type.toLowerCase() === 'player_start' && _Player2.default._builtGraphics == false) {
								_Player2.default.setPosition(obj.x, obj.y);
								_Player2.default.buildGraphics();
							}
						});
						if (_Player2.default.getBounds().getX() !== null && _Player2.default.getBounds().getY() !== null) {
							_Player2.default.render(ctx, time);
						}
					}
				}
			});
			// render collisions for debugging
			if (this.collisions !== null && _Config2.default.renderCollisions === true) {
				ctx.fillStyle = "rgba(255, 240, 40, 0.5)";
				this.collisions.forEach(function (obj) {
...
document.addEventListener('DOMContentLoaded', function (e) {
	var gameObj = new _Game2.default(_Config2.default);
	console.log(gameObj);
});
...
var Viewport = function () {
    function Viewport(id, container, width, height, defaultScene) {
        _classCallCheck(this, Viewport);

        this.container = container;
        this.canvas = _index2.default.createCanvas(id, container, width, height);
	...
	function axiosWrapperClass() {
		...
		this.initialize = function (config) {
			if (_this.instance == null) {
				_this.instance = axios.create(config);
			}
		};
...
window.axiosInstance = window.axiosInstance || _axios2.default;
